...
這堂課也有期中考及期末考，考試內容都從講義上出，形式是紙筆測驗，每一次考試剛好涵蓋六個主題。想要考得好成績，拿到考古題會很有幫助。也會在期中考當天進行一次上機考，可以把他想成難度介於 Practice 和 Exercise之間的測驗，現場也會有 1de 2de ，如果沒有當場做出來也可以帶回家慢慢做，但分數就會被打對折。另外上機考試只能使用 Vim 或 Gedit 這兩個文字編輯器，對於原本習慣用其他文字編輯器的同學會是個需要克服的點。
